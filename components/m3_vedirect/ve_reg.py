...
REG_DEFS = {
    ...
    TYPE.VOLTAGE_COMPENSATION.name: REG_DEF(
        "MPPT", CLASS.NUMERIC, 0xEDCA, ACCESS.READ_WRITE
    ),
    ...
    TYPE.BAT_LOW_TEMP_LEVEL.name: REG_DEF(
        "MPPT", CLASS.NUMERIC, 0xEDE0, ACCESS.READ_WRITE
    ),
    TYPE.REBULK_VOLTAGE_OFFSET.name: REG_DEF(
        "MPPT", CLASS.NUMERIC, 0xEDE2, ACCESS.READ_WRITE
    ),
    TYPE.EQUALISATION_DURATION.name: REG_DEF(
        "MPPT", CLASS.NUMERIC, 0xEDE3, ACCESS.READ_WRITE
    ),
    TYPE.EQUALISATION_CURRENT_LEVEL.name: REG_DEF(
        "MPPT", CLASS.NUMERIC, 0xEDE4, ACCESS.READ_WRITE
    ),
    TYPE.AUTO_EQUALISE_STOP_ON_VOLTAGE.name: REG_DEF(
        "MPPT", CLASS.BOOLEAN, 0xEDE5, ACCESS.READ_WRITE
    ),
    TYPE.LOW_TEMP_CHARGE_CURRENT.name: REG_DEF(
        "MPPT", CLASS.NUMERIC, 0xEDE6, ACCESS.READ_WRITE
    ),
    TYPE.BMS_PRESENT.name: REG_DEF("MPPT", CLASS.BOOLEAN, 0xEDE8, ACCESS.READ_WRITE),
    TYPE.BAT_VOLTAGE_SETTING.name: REG_DEF(
        "MPPT", CLASS.ENUM, 0xEDEA, ACCESS.READ_WRITE
    ),
    TYPE.BAT_TEMPERATURE.name: REG_DEF("ANY", CLASS.NUMERIC, 0xEDEC, ACCESS.READ_ONLY),
    TYPE.BAT_VOLTAGE.name: REG_DEF("MPPT", CLASS.NUMERIC, 0xEDEF, ACCESS.READ_ONLY),
    TYPE.BAT_MAX_CURRENT.name: REG_DEF(
        "MPPT", CLASS.NUMERIC, 0xEDF0, ACCESS.READ_WRITE
    ),
    TYPE.BAT_TYPE.name: REG_DEF("MPPT", CLASS.ENUM, 0xEDF1, ACCESS.READ_WRITE),
    TYPE.BAT_TEMPERATURE_COMPENSATION.name: REG_DEF(
        "MPPT", CLASS.NUMERIC, 0xEDF2, ACCESS.READ_WRITE
    ),
    TYPE.BAT_EQUALISATION_VOLTAGE.name: REG_DEF(
        "MPPT", CLASS.NUMERIC, 0xEDF4, ACCESS.READ_WRITE
    ),
    TYPE.BAT_FLOAT_VOLTAGE.name: REG_DEF(
        "MPPT", CLASS.NUMERIC, 0xEDF6, ACCESS.READ_WRITE
    ),
    TYPE.BAT_ABSORPTION_VOLTAGE.name: REG_DEF(
        "MPPT", CLASS.NUMERIC, 0xEDF7, ACCESS.READ_WRITE
    ),
    TYPE.BAT_ABSORPTION_LIMIT.name: REG_DEF(
        "MPPT", CLASS.NUMERIC, 0xEDFB, ACCESS.READ_WRITE
    ),
    TYPE.BAT_BULK_LIMIT.name: REG_DEF("MPPT", CLASS.NUMERIC, 0xEDFC, ACCESS.READ_WRITE),
    TYPE.AUTOMATIC_EQUALISATION_MODE.name: REG_DEF(
        "MPPT", CLASS.NUMERIC, 0xEDFD, ACCESS.READ_WRITE
    ),
    TYPE.ADAPTIVE_MODE.name: REG_DEF("MPPT", CLASS.BOOLEAN, 0xEDFE, ACCESS.READ_WRITE),
